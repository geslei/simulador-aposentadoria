...
st.write(f"Isto é apenas uma simulação. A concessão depende da análise do órgão previdenciário. Esta simulação não substitui a consulta a um profissional especializado.")
