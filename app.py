...
st.write("Isto é apenas uma simulação, a concessão depende da análise do órgão responsável. Essa simulação é apenas um referencial e não substitui a consulta de um profissional especializado")
